            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="media">
                            <?php
                            $path = base_url('public/dist/img/user1-128x128.jpg')
                            ?>
                            <img src="<?php echo $path ?>" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="media">
                            <?php
                            $path = base_url('public/dist/img/user8-128x128.jpg')
                            ?>
                            <img src="<?php echo $path ?>" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="media">
                            <?php
                            $path = base_url('public/dist/img/user3-128x128.jpg')
                            ?>
                            <img src="<?php echo $path ?>" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
